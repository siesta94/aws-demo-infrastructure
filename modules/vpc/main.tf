...
# Create Private Route Tables for Application Subnets
...
# Create route to NAT Gateway in Private App Route Tables
...
# Create Private Route Table for Database Subnets
